...
async function main() {
  const file = 'c:/Users/Love/Documents/Codex/TKBCherry/scratch/school_95671c41791.json';
  await profileSingleMode('SCHOOL 95671c41791', file, 'optimize_singletons', 10000);
  await profileSingleMode('SCHOOL 95671c41791', file, 'optimize_gap2', 10000);
  await profileSingleMode('SCHOOL 95671c41791', file, 'optimize_sessions', 10000);
  await profileSingleMode('SCHOOL 95671c41791', file, 'optimize_gap1', 10000);
}
