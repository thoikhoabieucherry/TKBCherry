...
// Ensure isLessonBlockSafe returns strict 0 violations
...
// Add strict violation check to all optimizer acceptance conditions
engineCode = engineCode.replace(/if\(newM\.soBuoiDay1 < metrics\.soBuoiDay1 && newM\.soBuoiTrong2 <= maxGap2Limit\){/g, 'if(newM.soBuoiDay1 < metrics.soBuoiDay1 && newM.soBuoiTrong2 <= maxGap2Limit && this.evaluateLessonBlockViolations() === 0){');

engineCode = engineCode.replace(/if\(currentM\.soBuoiDay1 <= bestMetrics\.soBuoiDay1\){/g, 'if(currentM.soBuoiDay1 <= bestMetrics.soBuoiDay1 && this.evaluateLessonBlockViolations() === 0){');

engineCode = engineCode.replace(/if\(oblitM && oblitM\.soBuoiDay1 < bestMetrics\.soBuoiDay1/g, 'if(oblitM && this.evaluateLessonBlockViolations() === 0 && oblitM.soBuoiDay1 < bestMetrics.soBuoiDay1');

engineCode = engineCode.replace(/if\(resSingle && resSingle\.soBuoiDay1 < bestMetrics\.soBuoiDay1/g, 'if(resSingle && this.evaluateLessonBlockViolations() === 0 && resSingle.soBuoiDay1 < bestMetrics.soBuoiDay1');

engineCode = engineCode.replace(/if\(resReinforce && resReinforce\.soBuoiDay1 < bestMetrics\.soBuoiDay1/g, 'if(resReinforce && this.evaluateLessonBlockViolations() === 0 && resReinforce.soBuoiDay1 < bestMetrics.soBuoiDay1');

engineCode = engineCode.replace(/if\(resGap && resGap\.soBuoiDay1 <= bestMetrics\.soBuoiDay1\){/g, 'if(resGap && this.evaluateLessonBlockViolations() === 0 && resGap.soBuoiDay1 <= bestMetrics.soBuoiDay1){');
