...
optimizer_code = """    // Intra-Class Same-Teacher Consolidation: Merges multiple single periods of the same teacher in the same class into the same session
...
new_text = text[:pos_start] + optimizer_code + text[pos_end:]

with open(engine_path, "w", encoding="utf-8") as f:
    f.write(new_text)

print("Safely replaced optimizer in engine with zero-violation guards and perfect backtrack semantics!")
