...
test("planner keeps eight compact, accessible commands in the mobile toolbar", () => {
  ...
  assert.match(plannerHtml, /phanmon\.js\?v=20260719-v146-strict-first-quality-gate-v1/);
  assert.match(plannerHtml, /tkb-rust-bridge\.js\?v=20260719-v146-strict-first-quality-gate-v1/);
});
