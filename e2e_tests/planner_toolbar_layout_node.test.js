...
test("planner keeps eight compact, accessible commands in the mobile toolbar", () => {
  ...
  assert.match(plannerHtml, /phanmon\.js\?v=20260719-v147-stable-active-progress-v1/);
  assert.match(plannerHtml, /tkb-rust-bridge\.js\?v=20260719-v147-stable-active-progress-v1/);
});
